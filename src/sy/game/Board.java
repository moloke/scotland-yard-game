...
import sy.utilities.BoardFileParser;
import sy.utilities.DistancesFileParser;
...
public class Board {
    ...
    private static final String BOARD_FILE_NAME = "src/resources/board_file.xml";
    private static final String HIDERS_DISTANCES_FILE_NAME = "src/resources/hiders_distances_file.xml";
    private static final String SEEKERS_DISTANCES_FILE_NAME = "src/resources/seekers_distances_file.xml";
